...
dependencies {
    "googleplayImplementation"("com.google.firebase:firebase-crashlytics:20.1.0")
    implementation("androidx.annotation:annotation:1.10.0")
    implementation("androidx.core:core-ktx:1.15.0") //   # stable, for Liar API: Fatal Exception: java.lang.NoSuchMethodError: No virtual method getRoundedCorner(I)Landroid/view/RoundedCorner; in class Landroid/view/Display
